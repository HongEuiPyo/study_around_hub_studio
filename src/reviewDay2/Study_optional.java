...
public class Study_optional {
    ...
    public void main(String[] args) {
        ...
        // isPresent/isEmpty
        // isPresnet는 최종적으로 연산이 끝나고 객체가 존재하는지 확인하는 기능을 제공
        ...
        // ifPresent는 연산을 끝내고 객체가 존재한다면 그 객체를 입력값을 주는 기능을 제공
        Optional.of("Text")
        ...
        // orElse
        SampleObject sampleObject3 = Optional.ofNullable(new SampleObject("flature123", "around hub studio", "12"))
        ...
        SampleObject sampleObject4 = Optional.ofNullable(new SampleObject("flature123", "around hub studio", "12"))
...
class SampleObject {
    ...
    public SampleObject(String id, String name, String pwd) {
        this.id = id;
        this.name = name;
        this.pwd = pwd;
    }
